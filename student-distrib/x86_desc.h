...
extern page_struct first_page_table[1024];
extern page_struct page_directory[1024];
extern page_struct vidmap_page[1024];

//extern page_struct page_directory[1024] __attribute__((aligned(4096)));
//extern page_struct first_page_table[1024] __attribute__((aligned(4096)));
